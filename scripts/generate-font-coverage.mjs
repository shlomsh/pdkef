 ...
 * fontFileHasGlyph() (src/editor/text/fontCoverageLookup.js), which stays
 * synchronous and pure either way. This module is data only (ARCH-22): the
 * lookup functions that used to live here are hand-written source in that
 * sibling module, which imports the three exports below.
 *
