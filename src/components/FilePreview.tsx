...
// Twice the CSS box (see `.icon` in ToolShell.module.css) so the render holds
// up on a retina screen; renderThumbnail's default is tuned for the Merge
// list's own 150px thumbnails, not this slot.
const PDF_PREVIEW_WIDTH = 112;
