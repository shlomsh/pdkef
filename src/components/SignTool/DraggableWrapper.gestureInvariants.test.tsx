...
// type already has this coverage (DraggableWrapper.interaction.test.tsx,
// PdfRedactTool.test.tsx); this file generalizes the three gesture invariants
...
describe('DraggableWrapper gesture invariants (E1.5)', () => {
  ...
  describe('shape (rectangle/ellipse)', () => {
    ...
    // If DraggableWrapper.tsx's per-handle math regressed back to the
  ...
  //    user did NOT drag; DraggableWrapper.tsx's line-start/line-end branches
  ...
  //    preserve an edge on resize: DraggableWrapper.tsx:289-301 grows/shrinks
