...
export const tools = [
...

  {
    ...
    icon: Merge,
    gridTitle: 'Merge PDF',
    gridDescription: 'Combine multiple PDFs into a single document in seconds.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    gridDescription: 'Convert PDF pages into high-quality JPG or PNG images.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    gridDescription: 'Combine JPG or PNG images into a single PDF document.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    icon: Split,
    gridTitle: 'Split PDF',
    gridDescription: 'Extract specific pages or separate a PDF into multiple files.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    gridDescription: 'Reduce the file size of your PDF without losing quality.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    seoTitle: 'Unlock PDF Online Free - Remove PDF Password | PDkef',
    seoDescription:
      'Remove a password from a PDF file online for free. Enter the password once and download an unlocked copy. 100% private, runs in your browser.',
    schemaName: 'PDkef - Unlock PDF',
    toolName: 'Unlock PDF',
    h1: 'Unlock PDF Free: No Sign-Up, Runs Locally',
    subhead:
      'Remove a known password from a PDF, or add one to protect a file - the tool detects which you need.',
    ariaLabel: 'PDF unlock tool',
    aboutHeading: 'How to unlock a password-protected PDF online for free',
    aboutLead:
      'Remove a password from your PDF, right in your browser. No upload, no server. Your file and its password never leave your device.',
    freeNoteLead:
      'Remove a known password from as many PDFs as you like, with no watermark or usage caps. Because the file and its password are processed on your device, nothing is ever uploaded.',
    aboutSketch: 'rings',
    aboutIconPos: 'tl',
    faqSketch: 'grid',
    faqIconPos: 'br',
    steps: [
      { title: 'Upload your PDF', text: 'Select or drag-and-drop the password-protected file.' },
      { title: 'Enter the password', text: 'Type the password currently required to open the PDF.' },
      { title: 'Unlock and download', text: 'Click Unlock PDF and save a copy with the password removed.' },
    ],
    faq: [
      { question: 'Is unlocking a PDF here secure?', answer: 'Yes. The password and the file are processed 100% client-side, entirely in your browser. Nothing is uploaded to any server.' },
      { question: 'Do I need to know the PDF password?', answer: 'Yes. This tool removes a password you already know from a PDF - it does not crack, guess, or recover unknown passwords.' },
      ...
      { question: 'Is there a limit on file size?', answer: "No artificial limit. Unlocking runs entirely on your device, so the only constraint is your device's available memory." },
    ],
  },

  {
    ...
    gridDescription: 'Remove, rotate, and add page numbers to your PDF file easily.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
...

  {
    ...
    gridDescription: 'Securely hide, blur, or black out sensitive text and flatten the document.',
    sitemapPriority: '0.9',
    sitemapChangefreq: 'monthly',
