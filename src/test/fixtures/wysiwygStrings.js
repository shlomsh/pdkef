...
export const WYSIWYG_STRING_CASES = Object.freeze([
  ...
  { id: 'A1', text: 'مرحبا بالعالم', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A2', text: 'لا لأ لإ لآ', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A3', text: 'مَرْحَبًا بِٱلْعَالَم', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A4', text: 'المبلغ 1,250.50 ريال', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A5', text: 'التاريخ ٢١/٠٨/٢٠٢٦', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A6', text: 'مرحبا أحمد 1250 ١٢٥٠ Ahmed', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
  { id: 'A7', text: 'دار زور ورد', direction: 'rtl', family: 'Vazirmatn', support: 'fallback' },
