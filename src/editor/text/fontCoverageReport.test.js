 ...
 * src/editor/text/languageAlphabets.js's character-set definitions) and fail, naming
...
import { LANGUAGES, CYRILLIC_ANCHOR_LANGUAGES, NAMED_COMBINATIONS } from './languageAlphabets.js';
