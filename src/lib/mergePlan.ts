...
// file's own name, plus how many other files were folded in. `template`
// lets a locale phrase this differently (e.g. count before name, as a
// Hebrew rendering of "+ N more" might); it must still contain both
// placeholders for otherCount > 0 to make sense, but this function does not
// validate that - it just substitutes.
