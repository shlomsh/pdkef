...
export const LANGUAGE_COVERAGE = {
  ...
  "cyrillicRussian": {
    ...
    full: [{ family: "Amatic SC", style: "handwriting" }, { family: "Arimo", style: "upright" }, { family: "Tinos", style: "upright" }, { family: "Cousine", style: "upright" }, { family: "PT Sans", style: "upright" }],
    partial: [],
  },
  "cyrillicUkrainian": {
    label: "Ukrainian",
...
export const COMBINATION_COVERAGE = [
  ...
  { a: "cyrillicRussian", b: "latin", aLabel: "Russian", bLabel: "Latin", families: [{ family: "Amatic SC", style: "handwriting" }, { family: "Arimo", style: "upright" }, { family: "Tinos", style: "upright" }, { family: "Cousine", style: "upright" }, { family: "PT Sans", style: "upright" }] },
