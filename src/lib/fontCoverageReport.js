...
export const LANGUAGE_COVERAGE = {
  "latin": {
    ...
    full: [{ family: "Caveat", style: "handwriting" }, { family: "Dancing Script", style: "handwriting" }, { family: "Great Vibes", style: "handwriting" }, { family: "Gveret Levin", style: "handwriting" }, { family: "Kalam", style: "handwriting" }, { family: "Mali", style: "handwriting" }, { family: "Neucha", style: "handwriting" }, { family: "Pacifico", style: "handwriting" }, { family: "Sacramento", style: "handwriting" }, { family: "Amatic SC", style: "handwriting" }, { family: "Arimo", style: "upright" }, { family: "Tinos", style: "upright" }, { family: "Cousine", style: "upright" }, { family: "Assistant", style: "upright" }, { family: "Heebo", style: "upright" }, { family: "Alef", style: "upright" }, { family: "PT Sans", style: "upright" }, { family: "Scheherazade New", style: "upright" }, { family: "Vazirmatn", style: "upright" }, { family: "Noto Sans JP", style: "upright" }, { family: "Noto Sans SC", style: "upright" }, { family: "Noto Sans TC", style: "upright" }, { family: "Noto Sans KR", style: "upright" }, { family: "Noto Sans Bengali", style: "upright" }, { family: "Mukta Mahee", style: "upright" }, { family: "Anek Telugu", style: "upright" }, { family: "Noto Sans Tamil", style: "upright" }, { family: "Mukta", style: "upright" }, { family: "IBM Plex Sans Thai", style: "upright" }, { family: "Anek Malayalam", style: "upright" }, { family: "Gayathri", style: "upright" }, { family: "Suranna", style: "upright" }, { family: "Tiro Tamil", style: "upright" }, { family: "Tiro Gurmukhi", style: "upright" }],
    partial: [],
  },
  "latinExt": {
    label: "Latin Extended (accented, representative sample)",
    requiredCodePointCount: 80,
    full: [{ family: "Kalam", style: "handwriting" }, { family: "Mali", style: "handwriting" }, { family: "Amatic SC", style: "handwriting" }, { family: "Arimo", style: "upright" }, { family: "Tinos", style: "upright" }, { family: "Cousine", style: "upright" }, { family: "Heebo", style: "upright" }, { family: "Alef", style: "upright" }, { family: "PT Sans", style: "upright" }, { family: "Vazirmatn", style: "upright" }, { family: "Noto Sans Bengali", style: "upright" }, { family: "Mukta Mahee", style: "upright" }, { family: "Noto Sans Tamil", style: "upright" }, { family: "Mukta", style: "upright" }],
