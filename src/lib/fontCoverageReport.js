...
export const LANGUAGE_COVERAGE = {
  ...
  "latinExt": {
    ...
    full: [{ family: "Kalam", style: "handwriting" }, { family: "Mali", style: "handwriting" }, { family: "Amatic SC", style: "handwriting" }, { family: "Arimo", style: "upright" }, { family: "Tinos", style: "upright" }, { family: "Cousine", style: "upright" }, { family: "Heebo", style: "upright" }, { family: "Alef", style: "upright" }, { family: "PT Sans", style: "upright" }, { family: "Noto Sans Bengali", style: "upright" }, { family: "Mukta Mahee", style: "upright" }, { family: "Noto Sans Tamil", style: "upright" }, { family: "Mukta", style: "upright" }],
