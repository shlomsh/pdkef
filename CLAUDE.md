...
- **Explain, don't compete.** Never argue against named competitors or use an us-vs-them tone. State why the tool exists and how it works; the facts carry themselves. (`src/data/tools.js` FAQs no longer name competitors; do not add that framing back.)
