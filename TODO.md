...
## Module boundaries: one folder per tool, an enforced dependency graph, Nx on top (2026-09-13)
...
## Architecture debt: what the module-boundaries review found (2026-09-14)
...
| DEBT-20 | P3 | [DEBT-20](backlog/tasks/DEBT-20.md) · Nothing checks that a navigating-away flag uses the hook that survives a Back |
