...
- Wave 5 (2026-09-13): rotate, skip and open show a visible word under the button on hover and keyboard focus (Rotate, Skip or Bring back, Open); the aria-label stays the accessible name.
- 2026-09-13, evening (Shlomi): on a phone the per-page rotate / skip / open cluster is revealed by a tap on the page, one page at a time (`data-selected`), and "Edit pages" is gone; three 44px buttons never overlap a neighbour's now. Desktop hover and :focus-visible reveal unchanged. Landed on main in 204c9be.
