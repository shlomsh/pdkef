# Migrated TODO context

> This is non-actionable supporting context migrated from the former monolithic `TODO.md`. Canonical task state and acceptance criteria live only in `backlog/tasks/`.
