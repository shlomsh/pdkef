...
paths:
  ...
  - "src/editor-ui/ArmHint*"
  - "src/editor-ui/ViewControl*"
  - "src/editor-ui/FullscreenButton*"
  - "src/editor-ui/UndoHistoryModal*"
  - "src/shell/BasePdfTool*"
  - "src/shell/ToolShell*"
  - "src/editor-ui/PdfPageCanvas*"
  - "src/shell/PdfShareButton*"
  - "src/shell/DownloadButton*"
  - "src/editor-ui/*Picker*"
  - "src/shell/Popover*"
