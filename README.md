...
**Type in your own alphabet.** The Sign tool's text boxes and typed signatures work in Hebrew, Arabic, Urdu, Japanese, Bengali, Hindi and Marathi (Devanagari), Vietnamese, Thai, Ukrainian (Cyrillic), and Greek, alongside Latin - joined Arabic letters connect and change shape the way handwritten Arabic actually does, not just individual boxes side by side. Each bundled font is checked against its real glyph coverage, so what you see on screen is what ends up embedded in the PDF you download.
