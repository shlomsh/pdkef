...
**Type in your own alphabet, right-to-left included.** The Sign tool's text boxes and typed signatures work in 20 languages and scripts: every Latin-script language, Chinese (Simplified and Traditional), Hindi, Marathi and other Devanagari languages, Arabic, Bengali, Telugu, Tamil, Punjabi (Gurmukhi), Russian, Ukrainian and other Cyrillic languages, Urdu, Japanese, Dari and Farsi, Vietnamese, Korean, Thai, Pashto, Greek, Hebrew, Malayalam, and Turkish. Hebrew and Arabic text boxes grow leftward from a fixed right edge, the way right-to-left writing actually behaves, and joined Arabic letters connect and change shape the way handwritten Arabic does, not just individual boxes side by side. Each bundled font is checked against its real glyph coverage, so what you see on screen is what ends up embedded in the PDF you download, and if a character has no glyph, the tool tells you while you're still typing, not after you download.
