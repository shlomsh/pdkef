...
- This review is a reading of the actual working-tree source (`src/pages/index.astro`,
  ...
  `src/pages/index.md.ts`, `src/site-lib/markdownRender.js`), not a browser audit, not a Lighthouse run, and
