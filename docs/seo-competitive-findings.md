...
| LOC-14 Indonesian target-size gate | open | 2026-09-12 | LOC-11's autocomplete sweep found the size-limit family densest in Indonesian (`kompres pdf 1 mb`, `mengecilkan pdf 200 kb`, `ukuran file lamaran kerja`), the intent `/pdf-wont-compress-to-100kb/` already serves in English; **Keyword Planner run 2026-09-12**: `kompres pdf 1 mb` at 50,000/mo (-90% 3-mo, flat YoY) plus 40+ variants at 500-5,000/mo each, clearing the demand bar decisively; `mengecilkan pdf 200 kb` and `kompres foto 200 kb` each only 500/mo, and most 200kb volume is photo not PDF; a real +900% YoY signal favors "under 1MB" phrasing over "to 1MB" (detail in LOC-14); Trends, `hl=id` SERPs and GSC Indonesia still needed before the gate can be read | Shlomi's Trends, SERP and GSC screenshots (links in LOC-14) |
