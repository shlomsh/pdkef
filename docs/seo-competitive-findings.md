...
| LOC-14 | open | Indonesian target-size compress: autocomplete sweep found the size-limit family densest in Indonesian (`kompres pdf 1 mb`, `mengecilkan pdf 200 kb`); run the ROI gate before any page |
