...
| SEO-17 Portal size-limits page | open | 2026-09-11 | picked up next; rejected the three-doorway-page brief (100kb/200kb/500kb) per CLAUDE.md, scoped instead as one page with real measured compression examples and cited portal limits | not started |
| SEO-16, 18 to 27 | open | | not started | per section 4 |
