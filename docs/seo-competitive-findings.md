...
| LOC-03 Hebrew pilot | open, shipped | 2026-09-11 | `/he/compress/`, `/he/merge/`, `/he/sign/` reviewed by Shlomi and live (indexable, in the sitemap); **indexing not yet requested** - that is the one step left, and the eight-week read counts from it | request indexing, record the date in LOC-03; then Hebrew queries in GSC via LOC-06's per-locale table |
